  ...
  return (
    <div id="Benifits" className="pb-12 md:py-24 lg:py-32">
      <div className="container max-w-[1140px] 2xl:max-w-[1320px] relative">
        <div className=" inline-flex justify-center items-center gap-2 md:inline-block md:absolute right-[6%] top-[-36%] xl:top-[-36%]  translate-x-6 py-5 md:py-0 ">
        ...
        <h2 className="font-Helvet font-normal text-3xl sm:text-custom-4xl lg:text-custom-5xl leading-[128%] text-center uppercase ">
